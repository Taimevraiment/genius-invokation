...
import { Card, CustomVersionConfig, ExplainContent, PlayerInfo, Hero, InfoVO, Skill, Status, Summon } from '../../../typing';
...
const playerInfo = computed<PlayerInfo | undefined>(() => props.playerInfo); // 玩家全局信息
