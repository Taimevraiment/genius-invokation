...
export const GUYU_PREIFIX = 'https://static-data.ame.piovium.org/api/v5/image/';
...
export const CARD_SUBTYPE_URL = {
    ...
    // [CARD_SUBTYPE.Weapon]: `${GUYU_PREIFIX}raw/UI_Gcg_Buff_Equip_Weapon`,
    ...
    // [CARD_SUBTYPE.Relic]: `${GUYU_PREIFIX}raw/UI_Gcg_Buff_Equip_Relic`,
    ...
    // [CARD_SUBTYPE.Talent]: `${GUYU_PREIFIX}raw/UI_Gcg_Buff_Equip_Talent`,
...
const elReactionExplain: Record<string, (...args: any) => string> = {
    ...
    月结晶: () => `【月结晶】：本伤害+1，并生成1张可以召唤并强化【月笼】的\\[月笼协奏]加入手牌`,
}
...
export const RULE_EXPLAIN: { [key: string]: string } = {
    充能: '角色使用\\「元素爆发」时，需要消耗*[充能]。角色使用\\「元素战技」或\\「普通攻击」后，会获得1点*[充能]。',
    ...
    下落攻击: '角色被切换为\\「出战角色」后，本回合内使用的下一个技能若为\\「普通攻击」，则被视为\\「下落攻击」。',
    万能元素骰: '*[万能元素骰]可以视为任何类型的元素，来支付各种费用。',
    无色元素骰: '可以用任意类型的元素骰子组合，来支付此类费用。',
    物理伤害: '物理伤害不会附着元素，也不会发生元素反应',
    水元素骰: diceExpl(DICE_TYPE.Hydro),
    水元素伤害: `附着‹2›水元素，可发生元素反应：；‹2›‹3›${elr('蒸发')}；‹2›‹4›${elr('感电')}；‹2›‹1›${elr('冻结')}；‹2›‹7›${elr('绽放')}；‹2›‹4›${elr('月感电')}；‹2›‹7›${elr('月绽放')}；‹2›‹6›${elr('月结晶')}`,
    附着水元素: `不通过伤害附着‹2›水元素时，发生的元素反应会忽略伤害效果：；‹2›‹3›${elr('蒸发', true)}；‹2›‹4›${elr('感电', true)}；‹2›‹1›${elr('冻结', true)}；‹2›‹7›${elr('绽放', true)}`,
    水元素相关反应: `‹2›‹3›${elr('蒸发')}；‹2›‹4›${elr('感电')}；‹2›‹1›${elr('冻结')}；‹2›‹7›${elr('绽放')}；‹6›‹2›${elr('结晶', '水')}；‹5›‹2›${elr('扩散', '水')}；‹2›‹4›${elr('月感电')}；‹2›‹7›${elr('月绽放')}；‹2›‹6›${elr('月结晶')}`,
    ...
    雷元素伤害: `附着‹4›雷元素，可发生元素反应：；‹4›‹1›${elr('超导')}；‹4›‹2›${elr('感电')}；‹4›‹3›${elr('超载')}；‹4›‹7›${elr('原激化')}；‹4›‹2›${elr('月感电')}`,
    附着雷元素: `不通过伤害附着‹4›雷元素时，发生的元素反应会忽略伤害效果：；‹4›‹1›${elr('超导', true)}；‹4›‹2›${elr('感电', true)}；‹4›‹3›${elr('超载', true)}；‹4›‹7›${elr('原激化', true)}`,
    雷元素相关反应: `‹4›‹1›${elr('超导')}；‹4›‹2›${elr('感电')}；‹4›‹3›${elr('超载')}；‹4›‹7›${elr('原激化')}；‹6›‹4›${elr('结晶', '雷')}；‹5›‹4›${elr('扩散', '雷')}；‹4›‹2›${elr('月感电')}`,
    ...
    岩元素伤害: `和已附着的元素发生元素反应：；‹6›‹1›${elr('结晶', '冰')}；‹6›‹2›${elr('结晶', '水')}；‹6›‹3›${elr('结晶', '火')}；‹6›‹4›${elr('结晶', '雷')}；‹6›‹2›${elr('月结晶')}`,
    附着岩元素: `不通过伤害附着‹6›岩元素时，发生的元素反应会忽略伤害效果：；‹6›‹1›${elr('结晶', '冰', true)}；‹6›‹2›${elr('结晶', '水', true)}；‹6›‹3›${elr('结晶', '火', true)}；‹6›‹4›${elr('结晶', '雷', true)}`,
    岩元素相关反应: `‹6›‹1›${elr('结晶', '冰')}；‹6›‹2›${elr('结晶', '水')}；‹6›‹3›${elr('结晶', '火')}；‹6›‹4›${elr('结晶', '雷')}；‹6›‹2›${elr('月结晶')}`,
    草元素骰: diceExpl(DICE_TYPE.Dendro),
    草元素伤害: `附着‹7›草元素元素，可发生元素反应：；‹7›‹2›${elr('绽放')}；‹7›‹3›${elr('燃烧')}；‹7›‹4›${elr('原激化')}；‹7›‹2›${elr('月绽放')}`,
    附着草元素: `不通过伤害附着‹7›草元素时，发生的元素反应会忽略伤害效果：；‹7›‹2›${elr('绽放', true)}；‹7›‹3›${elr('燃烧', true)}；‹7›‹4›${elr('原激化', true)}`,
    草元素相关反应: `‹7›‹2›${elr('绽放')}；‹7›‹3›${elr('燃烧')}；‹7›‹4›${elr('原激化')}；‹7›‹2›${elr('月绽放')}`,
    ...
    '「希穆兰卡」卡牌': '「希穆兰卡」卡牌包括：【墨色酒馆】、【星轨王城】、【森林的祝福】、【预言女神的礼物】、【「邪龙」的苏醒】、【旁白的注脚】、【「魔女M的祝福」】、【破碎之海】。',
    ...
    月结晶: '本伤害+1，并生成1张可以召唤并强化【月笼】的[【月笼协奏】]加入手牌。',
}
