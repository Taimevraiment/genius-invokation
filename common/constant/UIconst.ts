...
export const RULE_EXPLAIN: { [key: string]: string } = {
    ...
    水元素伤害: `附着‹2›水元素，可发生元素反应：；‹2›‹3›${elr('蒸发')}；‹2›‹4›${elr('感电')}；‹2›‹1›${elr('冻结')}；‹2›‹7›${elr('绽放')}；‹2›‹4›${elr('月感电')}；‹2›‹7›${elr('月绽放')}`,
    附着水元素: `不通过伤害附着‹2›水元素时，发生的元素反应会忽略伤害效果：；‹2›‹3›${elr('蒸发', true)}；‹2›‹4›${elr('感电', true)}；‹2›‹1›${elr('冻结', true)}；‹2›‹7›${elr('绽放', true)}`,
    水元素相关反应: `‹2›‹3›${elr('蒸发')}；‹2›‹4›${elr('感电')}；‹2›‹1›${elr('冻结')}；‹2›‹7›${elr('绽放')}；‹6›‹2›${elr('结晶', '水')}；‹5›‹2›${elr('扩散', '水')}；‹2›‹4›${elr('月感电')}；‹2›‹7›${elr('月绽放')}`,
