...
export const ELEMENT_TYPE_KEY = swapKeysAndValues(ELEMENT_TYPE);

export const PURE_ELEMENT_TYPE_KEY = swapKeysAndValues(PURE_ELEMENT_TYPE);
...
export const CMD_MODE = {
    ...
    FrontHero: 2, // 当前出战角色(cnt控制前后)元素骰子
...
export const VERSION = [
    'v3.3.0', 'v3.4.0', 'v3.5.0', 'v3.6.0', 'v3.7.0', 'v3.8.0',
    'v4.0.0', 'v4.1.0', 'v4.2.0', 'v4.3.0', 'v4.4.0', 'v4.5.0', 'v4.6.0', 'v4.6.1', 'v4.7.0',
] as const;
