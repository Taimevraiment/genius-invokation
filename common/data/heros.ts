...
import { hero } from './builder/heroBuilder.js';
import { skill } from './builder/skillBuilder.js';
...
const allHeros: Record<number, () => ReturnType<typeof hero>> = {

    1101: () => hero(1).name('甘雨').offline('v1').maxHp(12).maxHp(10, 'v5.5.0', 'v1').liyue().cryo().bow()
        ...
        .normalSkill('流天射术')
        .skills(
            skill('山泽麟迹').description('{dealDmg}，生成【sts111012】。')
            ...
            skill('霜华矢').description('{dealDmg}，对所有敌方后台角色造成2点[穿透伤害]。')
            ...
            skill('降众天华').description('{dealDmg}，对所有敌方后台角色造成1点[穿透伤害]，召唤【smn111011】。')
    ...
    1102: () => hero(2).name('迪奥娜').offline('v2').maxHp(12).maxHp(10, 'v6.0.0', 'v2').mondstadt().cryo().bow()
        ...
        .normalSkill('猎人射术')
        .skills(
            skill('猫爪冻冻').description('{dealDmg}，生成【sts111021】。')
            ...
            skill('最烈特调').description('{dealDmg}，治疗此角色2点，召唤【smn111023】。')
    ...
    1103: () => hero(3).name('凯亚').offline('v2').mondstadt().cryo().sword()
        ...
        .skills(
            ...
            skill('凛冽轮舞').description('{dealDmg}，生成【sts111031】。')
    ...
    1104: () => hero(4).name('重云').offline('v1').liyue().cryo().claymore()
        ...
        .normalSkill('灭邪四式')
        .skills(
            skill('重华叠霜').description('{dealDmg}，生成【sts111041】。')
            ...
            skill('云开星落').description('{dealDmg}。')
    ...
    1105: () => hero(5).name('神里绫华').offline('v1').inazuma().cryo().sword()
        ...
        .normalSkill('神里流·倾')
        .skills(
            skill('神里流·冰华').description('{dealDmg}。')
                ...
                .elemental().damage(3).cost(3),
            skill('神里流·霜灭').description('{dealDmg}，召唤【smn111051】。')
            ...
            skill('神里流·霰步').description('此角色被切换为「出战角色」时，附属【sts111052】，本回合下次「普通攻击」造成的伤害+1。（每回合2次）')
                ...
                .passive().perCnt(2).handle(event => {
                    ...
                    const isAddDmg = skill.perCnt > 0 && !heroStatus.has(111054);
                    if (isAddDmg) status.push(111054);
                    return { triggers: 'switch-to', status, exec: () => isAddDmg && skill.minusPerCnt() }
                })
        ),

    1106: () => hero(6).name('优菈').since('v3.5.0').offline('v2').mondstadt().cryo().claymore()
        ...
        .normalSkill('西风剑术·宗室')
        .skills(
            skill('冰潮的涡旋').description('{dealDmg}，如果角色未附属【sts111061】，则使其附属【sts111061】。')
            ...
            skill('凝浪之光剑').description('{dealDmg}，召唤【smn111062】。')
    ...
    1107: () => hero(7).name('申鹤').since('v3.7.0').liyue().cryo().polearm()
        ...
        .normalSkill('踏辰摄斗')
        .skills(
            skill('仰灵威召将役咒').description('{dealDmg}，生成【sts111071】。')
            ...
            skill('神女遣灵真诀').description('{dealDmg}，召唤【smn111073】。')
    ...
    1108: () => hero(8).name('七七').since('v4.0.0').offline('v3').liyue().cryo().sword()
        ...
        .normalSkill('云来古剑法')
        .skills(
            skill('仙法·寒病鬼差').description('召唤【smn111081】。')
    ...
    1109: () => hero(279).name('莱依拉').since('v4.3.0').sumeru().cryo().sword()
        ...
        .normalSkill('熠辉轨度剑')
        .skills(
            skill('垂裳端凝之夜').description('生成【sts111091】和【sts111092】。')
            ...
            skill('星流摇床之梦').description('{dealDmg}，召唤【smn111093】。')
    ...
    1110: () => hero(334).name('夏洛蒂').since('v4.5.0').maxHp(11).maxHp(10, 'v6.3.0').fontaine(HERO_TAG.ArkhePneuma).cryo().catalyst()
        ...
        .normalSkill('冷色摄影律')
        .skills(
            skill('取景·冰点构图法').description('{dealDmg}，目标角色附属【sts111101】。')
            ...
            skill('定格·全方位确证').description('{dealDmg}，治疗我方所有角色1点，召唤【smn111102】。')
    ...
    1111: () => hero(363).name('莱欧斯利').since('v4.7.0').fontaine(HERO_TAG.ArkheOusia).cryo().catalyst()
        ...
        .normalSkill('迅烈倾霜拳')
        .skills(
            skill('冰牙突驰').description('{dealDmg}，本角色附属【sts111111】。')
            ...
            skill('黑金狼噬').description('{dealDmg}，生成【sts111112】。；【本角色在本回合中受到伤害或治疗每累计到2次时：】此技能少花费1个元素骰（最多少花费2个）。')
            ...
            skill('黑金狼噬').passive(true).handle(event => {
    ...
    1112: () => hero(407).name('菲米尼').since('v5.0.0').fontaine(HERO_TAG.ArkhePneuma).fatui().cryo().claymore()
        ...
        .normalSkill('洑流剑')
        .skills(
            skill('浮冰增压').description('{dealDmg}，若角色未附属【sts111121】，则使其附属【sts111121】。')
            ...
            skill('猎影潜袭').description('{dealDmg}，本角色附属【sts111122】。')
    ...
    1113: () => hero(432).name('罗莎莉亚').since('v5.2.0').mondstadt().cryo().polearm()
        ...
        .normalSkill('教会枪术')
        .skills(
            skill('噬罪的告解').description('{dealDmg}，生成1层【sts111131】。（触发【sts111131】的效果时，会生成【sts111133】。）')
            ...
            skill('终命的圣礼').description('{dealDmg}，生成2层【sts111131】，召唤【smn111132】。')
    ...
    1114: () => hero(477).name('茜特菈莉').since('v5.7.0').natlan().cryo().catalyst()
        .src('https://act-upload.mihoyo.com/wiki-user-upload/2025/06/18/258999284/1328319efbaf428574bec761c1cfe636_8215594796556604414.png')
        .avatar('https://act-webstatic.mihoyo.com/hk4e/e20200928calculate/item_icon/6851f3bc/c14672813537ec7f5a9b7455e0ab08c4.png')
        .normalSkill('宿灵捕影')
        .skills(
            skill('霜昼黑星').description('{dealDmg}。自身进入【sts111141】，并获得1点「夜魂值」。生成1点【sts111142】和【sts111143】。（角色进入【sts111141】后不可使用此技能）')
            ...
            skill('诸曜饬令').description('{dealDmg}，对所有敌方后台角色造成1点[穿透伤害]。如可能，获得2点「夜魂值」。')
                .src('https://patchwiki.biligame.com/images/ys/3/3d/q2dsp3cno86nz4hqmhelua8t7039p0m.png',
                    'https://act-upload.mihoyo.com/wiki-user-upload/2025/06/18/258999284/30e9d35220a7ae49e3f079842780de9e_7909253825080492582.png')
                .burst(2).damage(2).cost(3).handle(({ cmds }) => (cmds.getNightSoul(2), { pdmg: 1 })),
            skill('奥秘传唱').description('【我方进行[挑选]或造成元素反应伤害后：】如可能，获得1点「夜魂值」。（每回合1次）')
    ...
    1115: () => hero(533).name('爱可菲').since('v6.2.0').maxHp(11, 'v6.4.0').fontaine(HERO_TAG.ArkheOusia).cryo().polearm()
        ...
        .normalSkill('后厨手艺')
        .skills(
            skill('低温烹饪').description('{dealDmg}，召唤【smn111151】。')
                .src('https://patchwiki.biligame.com/images/ys/8/8d/k6oqleep7ovtakr6vdo4ux75txswf24.png',
            ...
            skill('花刀技法').description('{dealDmg}，治疗我方所有角色2点。')
                .src('https://patchwiki.biligame.com/images/ys/9/92/1jhkhnrrnueqljebyptqii3cs4jpxwk.png',
            ...
            skill('时时刻刻的即兴料理').description('战斗开始时，生成【crd111159】。')
                .src('https://patchwiki.biligame.com/images/ys/3/3f/i305nwa35n0zkiz2z2h399qn82lntun.png',
    ...
    1116: () => hero(544).name('丝柯克').since('v6.3.0').spMaxEnergy(7).cosmicCalamity().cryo().sword()
        .src('https://act-webstatic.mihoyo.com/hk4e/e20200928calculate/item_icon/6966dcbb/792673111d3461580f1344757ed93abb.png',
            'https://act-upload.mihoyo.com/wiki-user-upload/2026/01/12/258999284/7244ae4292fef550204eaf8d087b5035_3553632365591858769.png')
        .avatar('https://act-webstatic.mihoyo.com/hk4e/e20200928calculate/item_icon/6966dce3/54667f8409be4f7b9bcb35a958ffdfb8.png',
            '#Avatar_SkirkNew02')
        .normalSkill('极恶技·断')
        .skills(
        ...
        .skills(
            ...
            skill('速射牵制').description('【自身使用技能后：】下次我方造成的[物理伤害]+1。（每回合2次）')
                ...
                .passive().perCnt(2).handle(event => {
                    const { skill } = event;
                    if (skill.perCnt <= 0) return;
                    return { triggers: 'after-skill', status: 111173, exec: () => skill.minusPerCnt() }
                })
        ),
    ...
    1201: () => hero(9).name('芭芭拉').offline('v1').mondstadt().hydro().catalyst()
        ...
        .normalSkill('水之浅唱')
        .skills(
            skill('演唱，开始♪').description('{dealDmg}，召唤【smn112011】。')
            ...
            skill('闪耀奇迹').description('治疗我方所有角色4点。')
    ...
    1202: () => hero(10).name('行秋').offline('v2').liyue().hydro().sword()
        ...
        .normalSkill('古华剑法')
        .skills(
            skill('画雨笼山').description('{dealDmg}，本角色[附着水元素]，生成【sts112021】。')
            ...
            skill('裁雨留虹').description('{dealDmg}，本角色[附着水元素]，生成【sts112022】。')
    ...
    1203: () => hero(11).name('莫娜').offline('v1').mondstadt().hydro().catalyst()
        ...
        .normalSkill('因果点破')
        .skills(
            skill('水中幻愿').description('{dealDmg}，召唤【smn112031】。')
            ...
            skill('星命定轨').description('{dealDmg}，生成【sts112032】。')
            ...
            skill('虚实流动').description('【此角色为出战角色，我方执行「切换角色」行动时：】将此次切换视为「[快速行动]」而非「[战斗行动]」。（每回合1次）')
    ...
    1204: () => hero(12).name('达达利亚').since('v3.7.0').offline('v3').fatui().hydro().bow()
        ...
        .normalSkill('断雨')
        .skills(
            skill('魔王武装·狂澜').description('切换为【sts112042】，然后{dealDmg}，并使目标角色附属【sts112043】。')
            ...
            skill('极恶技·尽灭闪').description('依据【hro】当前所处状态，进行不同的攻击：；【远程状态·魔弹一闪】：{dealDmg}，返还2点[充能]，目标角色附属【sts112043】。；【近战状态·尽灭水光】：造成{dmg+2}点[水元素伤害]。')
            ...
            skill('遏浪').description('战斗开始时，初始附属【sts112041】。；角色所附属的【sts112042】效果结束时，重新附属【sts112041】。')
    ...
    1205: () => hero(13).name('珊瑚宫心海').since('v3.5.0').offline('v2').maxHp(12).maxHp(10, 'v5.5.0', 'v2').inazuma().hydro().catalyst()
        ...
        .normalSkill('水有常形')
        .skills(
            skill('海月之誓').description('本角色[附着水元素]，召唤【smn112051】。')
            ...
            skill('海人化羽').description('{dealDmg}，治疗我方所有角色1点，本角色附属【sts112052】。')
    ...
    1206: () => hero(14).name('神里绫人').since('v3.6.0').offline('v3').maxHp(11).maxHp(10, 'v6.3.0', 'v3').inazuma().hydro().sword()
        ...
        .normalSkill('神里流·转')
        .skills(
            skill('神里流·镜花').description('{dealDmg}，本角色附属【sts112061】。')
            ...
            skill('神里流·水囿').description('{dealDmg}，召唤【smn112062】。')
    ...
    1207: () => hero(15).name('坎蒂丝').since('v3.8.0').offline('v2').maxHp(11).maxHp(10, 'v5.7.0', 'v2').sumeru().hydro().polearm()
        ...
        .normalSkill('流耀枪术·守势')
        .skills(
            skill('圣仪·苍鹭庇卫').description('本角色附属【sts112071】并[准备技能]：【rsk12074】。')
            ...
            skill('圣仪·灰鸰衒潮').description('{dealDmg}，生成【sts112072】。')
    ...
    1208: () => hero(16).name('妮露').since('v4.2.0').sumeru().hydro().sword()
        ...
        .normalSkill('弦月舞步')
        .skills(
            skill('七域舞步').description('{dealDmg}，如果队伍中包含‹2水元素角色›和‹7草元素角色›且不包含其他元素的角色，就生成【sts112081】。')
                ...
                .elemental().damage(3).cost(3).handle(event => {
                    if (!event.heros.hasOnlyElements(ELEMENT_TYPE.Hydro, ELEMENT_TYPE.Dendro)) return;
                    return { statusPre: 112081 }
                }),
            skill('浮莲舞步·远梦聆泉').description('{dealDmg}，目标及下一个角色附属【sts112083】。')
    ...
    1209: () => hero(280).name('夜兰').since('v4.3.0').maxHp(11).maxHp(10, 'v6.4.0').liyue().hydro().bow()
        ...
        .normalSkill('潜形隐曜弓')
        .skills(
            skill('萦络纵命索').description('{dealDmg}，此角色的【sts112091】层数+2。')
            ...
            skill('渊图玲珑骰').description('{dealDmg}，生成【sts112092】。')
            ...
            skill('破局').description('战斗开始时，初始附属【sts112091】。')
    ...
    1210: () => hero(335).name('那维莱特').since('v4.5.0').maxHp(11).maxHp(10, 'v5.7.0').fontaine(HERO_TAG.ArkhePneuma).hydro().catalyst()
        ...
        .normalSkill('如水从平')
        .skills(
            skill('泪水啊，我必偿还').description('{dealDmg}，角色附属【sts112101】。')
            ...
            skill('潮水啊，我已归来').description('{dealDmg}，对所有后台敌人造成1点[穿透伤害]，生成[可用次数]为2的【sts112101】。')
    ...
    1211: () => hero(364).name('芙宁娜').since('v4.7.0').maxHp(12).maxHp(10, 'v6.2.0').fontaine(HERO_TAG.ArkheOusia).hydro().sword()
        ...
        .skills(
            allSkills[12112](),
            skill('万众狂欢').description('{dealDmg}，生成【sts112114】。')
            ...
            skill('始基力：圣俗杂座').id(12115).description('战斗开始时，生成手牌【crd112113】。')
                ...
                .passive().handle(({ cmds }) => (cmds.getCard(1, { card: 112113 }), { triggers: 'game-start' }))
        ),

    1213: () => hero(433).name('希格雯').since('v5.2.0').maxHp(12).maxHp(10, 'v5.5.0').fontaine(HERO_TAG.ArkheOusia).hydro().bow()
        ...
        .normalSkill('靶向治疗')
        .skills(
            skill('弹跳水疗法').description('生成1张【crd112131】，将其置于我方牌库顶部第3张牌的位置，本角色附属3层【sts122】。（触发【crd112131】的效果后，会生成【crd112132】并置入对方牌库\\；触发【crd112132】的效果后，会生成【crd112133】并置入我方牌库）')
                ...
                .elemental().cost(3).handle(({ cmds }) => (cmds.addCard(1, 112131, { addTo: 3 }), { status: [[122, 3]] })),
            skill('过饱和心意注射').description('{dealDmg}，然后[准备技能]：【rsk12135】。')
            ...
            skill('细致入微的诊疗').description('我方角色所附属的【sts122】被完全移除后，该角色获得1点额外最大生命值。（对每名角色最多生效3次）；【我方切换到本角色时：】如果我方场上存在【sts112101】，则使其[可用次数]-1，本角色获得1点[充能]。')
                ...
                .passive().handle(event => {
                    ...
                    if (trigger == 'switch-to' && combatStatus.has(112101) && !hero.isFullEnergy) {
    ...
    1214: () => hero(444).name('玛拉妮').since('v5.3.0').natlan().hydro().catalyst()
        ...
        .normalSkill('降温处理')
        .skills(
            skill('踏鲨破浪').description('自身附属【crd112142】，然后进入【sts112141】，并获得2点「夜魂值」。（角色进入【sts112141】后不可使用此技能）')
            ...
            skill('爆瀑飞弹').description('{dealDmg}，召唤【smn112144】。')
    ...
    1301: () => hero(17).name('迪卢克').offline('v1').mondstadt().pyro().claymore()
        ...
        .normalSkill('淬炼之剑')
        .skills(
            skill('逆焰之刃').description('{dealDmg}。每回合第三次使用本技能时，伤害+2。')
            ...
            skill('黎明').description('{dealDmg}，本角色附属【sts113011】。')
    ...
    1302: () => hero(18).name('香菱').offline('v1').liyue().pyro().polearm()
        ...
        .normalSkill('白案功夫')
        .skills(
            skill('锅巴出击').description('召唤【smn113021】。')
            ...
            skill('旋火轮').description('{dealDmg}，生成【sts113022】。')
    ...
    1303: () => hero(19).name('班尼特').mondstadt().pyro().sword()
        ...
        .normalSkill('好运剑')
        .skills(
            skill('热情过载').description('{dealDmg}。')
                ...
                .elemental().damage(3).cost(3),
            skill('美妙旅程').description('{dealDmg}，生成【sts113031】。')
    ...
    1304: () => hero(20).name('安柏').since('v3.7.0').offline('v2').maxHp(12).maxHp(10, 'v6.0.0', 'v2').mondstadt().pyro().bow()
        ...
        .normalSkill('神射手')
        .skills(
            skill('爆炸玩偶').description('召唤【smn113041】。')
            ...
            skill('箭雨').description('{dealDmg}，对所有敌方后台角色造成2点[穿透伤害]。')
    ...
    1305: () => hero(21).name('宵宫').offline('v3').inazuma().pyro().bow()
        ...
        .normalSkill('烟火打扬')
        .skills(
            skill('焰硝庭火舞').description('本角色附属【sts113051】。（此技能不产生[充能]）')
            ...
            skill('琉金云间草').description('{dealDmg}，生成【sts113052】。')
    ...
    1306: () => hero(22).name('可莉').since('v3.4.0').mondstadt().pyro().catalyst()
        ...
        .normalSkill('砰砰')
        .skills(
            skill('蹦蹦炸弹').description('{dealDmg}，本角色附属【sts113061】。')
            ...
            skill('轰轰火花').description('{dealDmg}，在对方场上生成【sts113063】。')
    ...
    1307: () => hero(23).name('胡桃').since('v3.7.0').offline('v2').maxHp(12).maxHp(10, 'v5.5.0', 'v2').liyue().pyro().polearm()
        ...
        .normalSkill('往生秘传枪法')
        .skills(
            skill('蝶引来生').description('本角色附属【sts113071】。')
            ...
            skill('安神秘法').description('{dealDmg}，治疗自身2点。如果本角色生命值不多于6，则造成的伤害和治疗各+1。')
    ...
    1308: () => hero(24).name('烟绯').since('v3.8.0').offline('v3').liyue().pyro().catalyst()
        ...
        .normalSkill('火漆印制')
        .skills(
            skill('丹书立约').description('{dealDmg}，本角色附属【sts113081】。')
            ...
            skill('凭此结契').description('{dealDmg}，本角色附属【sts113081】和【sts113082】。')
    ...
    1309: () => hero(25).name('迪希雅').since('v4.1.0').sumeru().eremite().pyro().claymore()
        ...
        .normalSkill('拂金剑斗术')
        .skills(
            skill('熔铁流狱').description('召唤【smn113093】\\；如果已存在【smn113093】，就先造成{dmg+1}点[火元素伤害]。')
            ...
            skill('炎啸狮子咬').description('{dealDmg}，然后[准备技能]：【rsk13095】。')
    ...
    1310: () => hero(281).name('林尼').since('v4.3.0').fontaine(HERO_TAG.ArkhePneuma).fatui().pyro().bow()
        ...
        .normalSkill('迫牌易位式')
        .skills(
            skill('隐具魔术箭').description('{dealDmg}，召唤【smn113101】，累积1层【sts113102】。；如果本角色生命值至少为6，则对自身造成1点[穿透伤害]。')
            ...
            skill('眩惑光戏法').description('{dealDmg}。')
                ...
                .elemental().damage(3).cost(3),
            skill('大魔术·灵迹巡游').description('{dealDmg}，召唤【smn113101】，累积1层【sts113102】。')
    ...
    1311: () => hero(319).name('托马').since('v4.4.0').offline('v3').maxHp(12).maxHp(10, 'v6.3.0', 'v3').inazuma().pyro().polearm()
        ...
        .normalSkill('迅破枪势')
        .skills(
            skill('烈烧佑命之侍护').description('{dealDmg}，生成【sts113111】。')
            ...
            skill('真红炽火之大铠').description('{dealDmg}，生成【sts113111】和【sts113112】。')
    ...
    1312: () => hero(365).name('辛焱').since('v4.7.0').liyue().pyro().claymore()
        ...
        .normalSkill('炎舞')
        .skills(
            skill('热情拂扫').description('{dealDmg}，随机[舍弃]1张[当前元素骰费用]最高的手牌，生成【sts113121】。')
    ...
    1313: () => hero(395).name('夏沃蕾').since('v4.8.0').fontaine(HERO_TAG.ArkheOusia).pyro().polearm()
        ...
        .normalSkill('线列枪刺·改')
        .skills(
            skill('近迫式急促拦射').description('{dealDmg}。；【此技能结算后：】如果我方手牌中含有【crd113131】，则[舍弃]1张并治疗我方受伤最多的角色1点。')
            ...
            skill('纵阵武力统筹').description('【敌方角色受到超载反应伤害后：】生成手牌【crd113131】。（每回合1次）')
    ...
    1314: () => hero(454).name('阿蕾奇诺').since('v5.4.0').fatui().pyro().polearm()
        ...
        .normalSkill(skill => skill('斩首之邀').description('，若可能，消耗目标至多3层【sts122】，提高等量伤害。')
            .handle(event => {
        ...
        .skills(
            skill('万相化灰').description('在对方场上生成3层【sts113141】，然后{dealDmg}。')
            ...
            skill('厄月将升').description('{dealDmg}，移除自身所有【sts122】，每移除1层，治疗自身1点。')
            ...
            skill('唯厄月可知晓').description('角色不会受到【ski,2】以外的治疗。；【自身附属〖sts122〗时：】角色造成的[物理伤害]变为[火元素伤害]。')
            ...
            skill().passive(true).handle(event => {
    ...
    1315: () => hero(478).name('玛薇卡').since('v5.7.0').spMaxEnergy(6).natlan().pyro().claymore()
        .src('https://act-upload.mihoyo.com/wiki-user-upload/2025/06/18/258999284/d1efa2f0e867de548415cdb7bfce1499_1736497909645663241.png')
        .avatar('https://act-webstatic.mihoyo.com/hk4e/e20200928calculate/item_icon/6851f3bc/bd52f08c820bc007bf2358413fba8bce.png')
        .normalSkill('以火织命')
        .skills(
            skill('称名之刻').description('自身进入【sts113151】，获得2点「夜魂值」，并从3张【驰轮车】中[挑选]1张加入手牌。')
            ...
            skill('燔天之时').description('本角色进入【sts113151】，获得1点「夜魂值」，消耗自身全部*[战意]，对敌方出战角色造成等同于消耗*[战意]数量[火元素伤害]。；若消耗了6点*[战意]，则自身附属【sts113152】。')
            ...
            skill('战意').description('角色不会获得[充能]。；在我方消耗「夜魂值」或使用「普通攻击」后，获得1点*[战意]。；本角色使用「元素战技」或「元素爆发」时，附属【sts113153】。')
    ...
    1316: () => hero(534).name('嘉明').since('v6.2.0').liyue().pyro().claymore()
        ...
        .normalSkill('刃爪悬星')
        .skills(
            skill('瑞兽登高楼').description('{dealDmg}，自身附属【sts113161】，我方切换到下一个角色。')
                .src('https://patchwiki.biligame.com/images/ys/4/4f/ie34sm1j4j5ini8zral4i0iche8kl24.png',
            ...
            skill('璨焰金猊舞').description('{dealDmg}，自身附属【sts113162】。')
    ...
    1401: () => hero(26).name('菲谢尔').mondstadt().electro().bow()
        ...
        .normalSkill('灭罪之矢')
        .skills(
            skill('夜巡影翼').description('{dealDmg}，召唤【smn114011】。')
            ...
            skill('至夜幻现').description('{dealDmg}，对所有敌方后台角色造成2点[穿透伤害]。')
    ...
    1402: () => hero(27).name('雷泽').offline('v3').mondstadt().electro().claymore()
        ...
        .normalSkill('钢脊')
        .skills(
            skill('利爪与苍雷').description('{dealDmg}。')
                ...
                .elemental().damage(3).cost(3),
            skill('雷牙').description('{dealDmg}，本角色附属【sts114021】。')
    ...
    1403: () => hero(28).name('刻晴').offline('v1').liyue().electro().sword()
        ...
        .normalSkill('云来剑法')
        .skills(
            skill('星斗归位').description('{dealDmg}，生成手牌【crd114031】。')
            ...
            skill('天街巡游').description('{dealDmg}，对所有敌方后台角色造成3点[穿透伤害]。')
    ...
    1404: () => hero(29).name('赛诺').sumeru().electro().polearm()
        ...
        .normalSkill('七圣枪术')
        .skills(
            skill('秘仪·律渊渡魂').description('{dealDmg}，【sts114041】的「凭依」级数+1。').description('{dealDmg}。', 'v4.8.0')
                ...
                .elemental().damage(3).cost(3),
            skill('圣仪·煟煌随狼行').description('{dealDmg}，【sts114041】的「凭依」级数+2。')
            ...
            skill('行度誓惩').description('战斗开始时，初始附属【sts114041】。')
    ...
    1405: () => hero(30).name('北斗').since('v3.4.0').offline('v2').maxHp(11).maxHp(10, 'v5.7.0', 'v2').liyue().electro().claymore()
        ...
        .normalSkill('征涛')
        .skills(
            skill('捉浪').description('本角色附属【sts114051】，并[准备技能]：【rsk14054】。')
            ...
            skill('斫雷').description('{dealDmg}，生成【sts114053】。')
    ...
    1406: () => hero(31).name('九条裟罗').since('v3.5.0').offline('v1').inazuma().electro().bow()
        ...
        .normalSkill('天狗传弓术')
        .skills(
            skill('鸦羽天狗霆雷召咒').description('{dealDmg}，召唤【smn114061】。')
    ...
    1407: () => hero(32).name('雷电将军').since('v3.7.0').offline('v3').inazuma().electro().polearm()
        ...
        .normalSkill('源流')
        .skills(
            skill('神变·恶曜开眼').description('召唤【smn114071】。')
            ...
            skill('奥义·梦想真说').description('{dealDmg}，其他我方角色获得2点[充能]。')
            ...
            skill('诸愿百眼之轮').description('战斗开始时，初始附属【sts114072】。')
    ...
    1408: () => hero(33).name('八重神子').since('v3.7.0').offline('v3').inazuma().electro().catalyst()
        ...
        .normalSkill('狐灵食罪式')
        .skills(
            skill('野千役咒·杀生樱').description('召唤【smn114081】。如果场上原本已存在【smn114081】，则额外使其造成的伤害+1。（最多+1）')
            ...
            skill('大密法·天狐显真').description('{dealDmg}\\；如果我方场上存在【smn114081】，则将其消灭，然后生成【sts114083】。')
    ...
    1409: () => hero(34).name('丽莎').since('v4.0.0').offline('v1').mondstadt().electro().catalyst()
        ...
        .normalSkill(skill => skill('指尖雷暴').description('；使敌方出战角色附属【sts114091】。')
        ...
        .skills(
            skill('苍雷').description('{dealDmg}\\；如果敌方出战角色未附属【sts114091】，则使其附属【sts114091】。')
            ...
            skill('蔷薇的雷光').description('{dealDmg}，召唤【smn114092】，使敌方出战角色附属【sts114091】。')
    ...
    1410: () => hero(35).name('多莉').since('v4.2.0').sumeru().electro().claymore()
        ...
        .normalSkill('妙显剑舞·改')
        .skills(
            skill('镇灵之灯·烦恼解决炮').description('{dealDmg}，召唤【smn114101】。')
            ...
            skill('卡萨扎莱宫的无微不至').description('{dealDmg}，召唤【smn114102】。')
    ...
    1411: () => hero(348).name('久岐忍').since('v4.6.0').inazuma().electro().sword()
        ...
        .normalSkill('忍流飞刃斩')
        .skills(
            skill('越袚雷草之轮').description('生成【sts114111】。如果本角色生命值至少为6，则对自身造成2点[穿透伤害]。')
            ...
            skill('御咏鸣神刈山祭').description('{dealDmg}，治疗本角色2点。')
    ...
    1412: () => hero(445).name('克洛琳德').since('v5.3.0').fontaine(HERO_TAG.ArkheOusia).electro().sword()
        ...
        .normalSkill(skill => skill('逐影之誓').damage(1)
        ...
        .skills(
            skill('狩夜之巡').description('自身附属【sts114121】，移除自身所有【sts122】。然后根据所移除的层数，造成[雷元素伤害]，并治疗自身。（伤害和治疗最多4点）')
            ...
            skill('残光将终').description('{dealDmg}，自身附属4层【sts122】。')
    ...
    1413: () => hero(469).name('赛索斯').since('v5.6.0').sumeru().electro().bow()
        ...
        .normalSkill(skill => skill('王家苇箭术').energy(-1))
        .skills(
            skill('古仪·鸣砂掣雷').description('敌方出战角色[附着雷元素]，我方切换到下一个角色。自身附属【sts114132】。')
                ...
                .elemental().cost(2).handle(({ cmds }) => (cmds.after.switchAfter(), { isAttachOppo: true, statusPre: 114132 })),
            skill('秘仪·瞑光贯影').description('{dealDmg}，自身附属【sts114131】。')
            ...
            skill('黑鸢的密喻').description('自身「普通攻击」不会获得[充能]。；自身「普通攻击」后：如可能，消耗全部[充能]，对生命值最低的敌方造成等额+1的[穿透伤害]。')
                .src('https://patchwiki.biligame.com/images/ys/7/71/ojtwo4ib1f0i8462d3jk7pjw6f86oxx.png',
    ...
    1414: () => hero(506).name('伊安珊').since('v6.0.0').maxHp(11).maxHp(12, 'v6.2.0').natlan().electro().polearm()
        .src('https://act-upload.mihoyo.com/wiki-user-upload/2025/09/09/258999284/898024fe1b7da0a2ca85d9c5dfd115af_5856139406581779483.png')
        .avatar('https://act-webstatic.mihoyo.com/hk4e/e20200928calculate/item_icon/68c0b1b4/8a424be2a08d93afc62ff888b32f9434.png')
        .normalSkill('负重锥击')
        .skills(
            skill('电掣雷驰').description('{dealDmg}，自身进入【sts114141】，获得1点「夜魂值」，生成1层【sts170】。')
            ...
            skill('力的三原理').description('{dealDmg}，自身进入【sts114141】，获得1点「夜魂值」，生成【sts114142】。')
                ...
                .burst(2).damage(2).damage(3, 'v6.2.0').cost(3).handle(event => {
                    const { cmds, talent } = event;
                    cmds.getStatus(114141).getNightSoul();
                    return { status: [[114142, !!talent]] }
                }),
            skill('热量均衡计划').description('自身处于【sts114141】时，我方角色[准备技能]或累计2次「切换角色」后，如果「夜魂值」为2，则治疗我方受伤最多的角色1点，否则，获得1点「夜魂值」。（每回合3次）')
    ...
    1415: () => hero(521).name('瓦雷莎').since('v6.1.0').natlan().electro().catalyst()
        .src('https://act-upload.mihoyo.com/wiki-user-upload/2025/10/19/258999284/0fed0793b4e875fe8972179809f9dde7_8861262489076230447.png')
        .avatar('https://act-webstatic.mihoyo.com/hk4e/e20200928calculate/item_icon/68f81ec5/df65120046a94453078de83a756db16e.png')
        .normalSkill(skill => skill('角力搏摔').description('【此次技能为[下落攻击]时：】造成的伤害+1，自身进入【sts114151】，并获得1点「夜魂值」。')
            .handle(event => {
        ...
        .skills(
            skill('夜虹逐跃').description('{dealDmg}，自身附属【sts114154】，进入【sts114151】，并获得1点「夜魂值」，然后我方切换到下一个角色。')
                .src('https://patchwiki.biligame.com/images/ys/6/64/5urbvso0qhm0b77t5vj3lr9m3t741fp.png',
                    'https://act-upload.mihoyo.com/wiki-user-upload/2025/10/19/258999284/839e11eebc9df599f89df322364261d1_7154275250751623092.png')
                .elemental().damage(2).cost(3).handle(({ cmds }) => cmds.getStatus([114154, 114151]).getNightSoul(1).switchAfter().res),
            skill('闪烈降临！').description('{dealDmg}，自身附属【sts114152】。')
                .src('https://patchwiki.biligame.com/images/ys/c/cd/qaqebxrnja20b64924duql0z3523bn3.png',
                    'https://act-upload.mihoyo.com/wiki-user-upload/2025/10/19/258999284/7028abae2ff6172ce29f8a6a6660e833_2206190065272515264.png')
                .burst(3).damage(3).cost(3).handle(() => ({ status: 114152 })),
            skill('连势，三重腾跃！').description('【〖hro〗使用技能后：】如果自身「夜魂值」等于2，则消耗2点「夜魂值」，自身附属【sts114152】。')
                .src('https://patchwiki.biligame.com/images/ys/e/e5/2phe6jv2402t53p4pohqr6urtbacxk5.png',
                    'https://act-upload.mihoyo.com/wiki-user-upload/2025/10/19/258999284/120e7d4a50cb1fe0f77f7d9a4c1c0dac_2932626368172569270.png')
                .passive().handle(event => {
    ...
    1416: () => hero(545).name('欧洛伦').since('v6.3.0').natlan().electro().bow()
        .src('https://act-webstatic.mihoyo.com/hk4e/e20200928calculate/item_icon/6966dcbb/b5c814d87bb619b8f0da38e463b26c5b.png')
        .avatar('https://act-webstatic.mihoyo.com/hk4e/e20200928calculate/item_icon/6966dce3/12c74aa8d1f230d4ccb06ba9347eaac7.png')
        .normalSkill('宿灵闪箭')
        .skills(
    ...
    1501: () => hero(36).name('砂糖').offline('v1').mondstadt().anemo().catalyst()
        ...
        .normalSkill('简式风灵作成')
        .skills(
            skill('风灵作成·陆叁零捌').description('{dealDmg}，使对方强制切换到前一个角色。')
            ...
            skill('禁·风灵作成·柒伍同构贰型').description('{dealDmg}，召唤【smn115011】。')
    ...
    1502: () => hero(37).name('琴').offline('v1').maxHp(12).maxHp(10, 'v5.5.0', 'v1').mondstadt().anemo().sword()
        ...
        .normalSkill('西风剑术')
        .skills(
            skill('风压剑').description('{dealDmg}，使对方强制切换到下一个角色。')
                ...
                .elemental().damage(3).cost(3).handle(({ cmds }) => { cmds.switchAfter(true) }),
            skill('蒲公英之风').description('治疗我方所有角色2点，召唤【smn115021】。')
    ...
    1503: () => hero(38).name('温迪').since('v3.7.0').offline('v2').maxHp(12).maxHp(10, 'v5.5.0', 'v2').mondstadt().anemo().bow()
        ...
        .normalSkill('神代射术')
        .skills(
            skill('高天之歌').description('{dealDmg}，生成【sts115031】。')
            ...
            skill('风神之诗').description('{dealDmg}，召唤【smn115034】。')
    ...
    1504: () => hero(39).name('魈').since('v3.7.0').offline('v2').liyue().anemo().polearm()
        ...
        .normalSkill('卷积微尘')
        .skills(
            skill('风轮两立').description('{dealDmg}。')
                ...
                .elemental().damage(3).cost(3),
            skill('靖妖傩舞').description('{dealDmg}，本角色附属【sts115041】。')
    ...
    1505: () => hero(40).name('枫原万叶').since('v3.8.0').offline('v3').inazuma().anemo().sword()
        ...
        .normalSkill('我流剑术')
        .skills(
            skill('千早振').description('{dealDmg}，本角色附属【sts115051】。；如果此技能引发了扩散，则将【sts115051】转换为被扩散的元素。；【此技能结算后：】我方切换到后一个角色。')
            ...
            skill('万叶之一刀').description('{dealDmg}，召唤【smn115052】。')
    ...
    1506: () => hero(41).name('流浪者').since('v4.1.0').anemo().catalyst()
        ...
        .normalSkill('行幡鸣弦')
        .skills(
            skill('羽画·风姿华歌').description('{dealDmg}，本角色附属【sts115061】。')
            ...
            skill('狂言·式乐五番').description('{dealDmg}\\；如果角色附属有【sts115061】，则将其移除并使此伤害+1。')
    ...
    1507: () => hero(320).name('早柚').since('v4.4.0').inazuma().anemo().claymore()
        ...
        .normalSkill('忍刀·终末番')
        .skills(
            skill('呜呼流·风隐急进').description('{dealDmg}，本角色[准备技能]：【rsk15074】。；如果当前技能引发了扩散，则【rsk15074】将改为造成被扩散元素的伤害。')
            ...
            skill('呜呼流·影貉缭乱').description('{dealDmg}，召唤【smn115072】。')
    ...
    1508: () => hero(282).name('琳妮特').since('v4.3.0').fontaine(HERO_TAG.ArkheOusia).fatui().anemo().sword()
        ...
        .normalSkill('迅捷礼刺剑')
        .skills(
            skill('谜影障身法').description('{dealDmg}，本回合第一次使用此技能、且自身生命值不多于8时，治疗自身2点，但是附属【sts115081】。')
                ...
                .elemental().damage(3).cost(3).handle(event => {
                    const { hero: { hp }, skill: { useCntPerRound }, talent, cmds } = event;
                    const cdt = hp <= 8 && useCntPerRound == 0;
                    const isTalent = talent && useCntPerRound == 1;
                    if (isTalent) cmds.switchBefore(true);
                    return {
                        heal: isCdt(cdt, 2),
            ...
            skill('魔术·运变惊奇').description('{dealDmg}，召唤【smn115082】。')
    ...
    1509: () => hero(349).name('珐露珊').since('v4.6.0').sumeru().anemo().bow()
        ...
        .normalSkill('迴身箭术')
        .skills(
            skill('非想风天').description('{dealDmg}，本角色附属【sts115091】。')
            ...
            skill('抟风秘道').description('{dealDmg}，召唤【smn115093】。')
    ...
    1511: () => hero(479).name('恰斯卡').since('v5.7.0').natlan().anemo().bow()
        .src('https://act-upload.mihoyo.com/wiki-user-upload/2025/06/17/258999284/8a7080b824a2cc2bebb4dc696f354ec0_1125758293638464105.png')
        .avatar('https://act-webstatic.mihoyo.com/hk4e/e20200928calculate/item_icon/6851f3bc/9108fdad84c0005ae0f4acd5b1e73f06.png')
        .normalSkill('迷羽流击')
        .skills(
            skill('灵缰追影').description('{dealDmg}，抓1张牌。；本角色附属【crd115112】，进入【sts115111】，并获得2点「夜魂值」。（角色进入【sts115111】后不可使用此技能）；【我方接下来2次「切换角色」时：】抓1张牌。')
                .src('https://patchwiki.biligame.com/images/ys/c/ce/30gw2p8argyztwc3bkcu8ywk8rcw102.png',
                    'https://act-upload.mihoyo.com/wiki-user-upload/2025/06/17/258999284/a17eb41be64eca6dd82798d28c726016_647712972431004942.png')
            ...
            skill('索魂命袭').description('{dealDmg}，对敌方所有后台角色造成1点穿透伤害，并抓3张牌。')
                .src('https://patchwiki.biligame.com/images/ys/4/47/c00k2jsyfpdgrf5w14na5o4p9v30jxj.png',
                    'https://act-upload.mihoyo.com/wiki-user-upload/2025/06/17/258999284/37086ae15e5cd7d9beafd2a1e8f3e715_9061455789109395645.png')
                .burst(2).damage(1).cost(3).handle(({ cmds }) => (cmds.getCard(3), { pdmg: 1 })),
            skill('追影弹').description('对局开始时，将6枚【crd115113】随机放置进牌库。')
                .src('https://patchwiki.biligame.com/images/ys/e/e1/m7tb5ulf4v5dw57zmzaouy5p11mvfz5.png',
    ...
    1512: () => hero(492).name('蓝砚').since('v5.8.0').liyue().anemo().catalyst()
        ...
        .normalSkill('玄鸾画水')
        .skills(
            skill('凤缕随翦舞').description('生成2层【sts115121】，获得1层【sts169】，并{dealDmg}，如果此技能引发了扩散，则额外生成1层【sts115121】。')
                .src('https://patchwiki.biligame.com/images/ys/0/02/iesatcgjl13ypmqpdw9mhaazb5iq7bv.png',
                ...
                .elemental().damage(1).cost(3).handle(({ swirlEl }) => ({ statusPre: [[115121, 2 + +!!swirlEl], 169] })),
            skill('鹍弦踏月出').description('{dealDmg}，生成2层【sts115121】。')
                .src('https://patchwiki.biligame.com/images/ys/0/0e/fjngp9l9w9pn1jkmyi75qjysci64c3c.png',
    ...
    1513: () => hero(493).name('鹿野院平藏').since('v5.8.0').inazuma().anemo().catalyst()
        ...
        .normalSkill('不动流格斗术')
        .skills(
            skill('勠心拳').description('[准备技能]：【rsk15135】。')
            ...
            skill('聚风蹴').description('{dealDmg}，如果此技能引发了[风元素相关反应]，则敌方出战角色附属对应元素的【nbotsts115130】。')
                .src('https://patchwiki.biligame.com/images/ys/8/81/ttxakaegstyr11q50wcz5uz9baj98h7.png',
            ...
            skill('反论稽古').description('【我方引发了[风元素相关反应]后：】自身附属1层【sts115132】。')
                .src('https://patchwiki.biligame.com/images/ys/c/cf/fxstkg5k4y169yhg8mj5i1n2gi5wai2.png',
    ...
    1514: () => hero(507).name('梦见月瑞希').since('v6.0.0').inazuma().anemo().catalyst()
        .src('https://act-upload.mihoyo.com/wiki-user-upload/2025/09/09/258999284/54c4091eb968d13ee0badf57e2f81cb3_406792605011322985.png')
        .avatar('https://act-webstatic.mihoyo.com/hk4e/e20200928calculate/item_icon/68c0b1b4/4e5c79477c8cfc62faf2926d6da5d338.png')
        .normalSkill('梦我梦心')
        .skills(
            skill('秋沙歌枕巡礼').description('{dealDmg}，自身附属【sts115141】。')
            ...
            skill('安乐秘汤疗法').description('{dealDmg}，生成1张【crd115142】，将其置于我方牌组顶部，并召唤【smn115143】。')
                .src('https://patchwiki.biligame.com/images/ys/0/09/i8hgtjecul2n3a0ttf2ijwu6mib8rc8.png',
    ...
    1515: () => hero(522).name('伊法').since('v6.1.0').natlan().anemo().catalyst()
        .src('https://act-upload.mihoyo.com/wiki-user-upload/2025/10/21/258999284/e3d934fc0300c7e7cf28202538c171ee_9058086577125861662.png')
        .avatar('https://act-webstatic.mihoyo.com/hk4e/e20200928calculate/item_icon/68f81ec5/3fb3bfa2ea58ca226538dfe54703ea45.png')
        .normalSkill('祛风妙仪')
        .skills(
            ...
            skill('复合镇静域').description('{dealDmg}，治疗我方受伤最多的角色2点。如果此技能引发了[风元素相关反应]，则敌方出战角色附属对应元素的【sts115150】。')
                .src('https://patchwiki.biligame.com/images/ys/2/20/3te5vpwe3cuf00eyu206wiwu5rp9xku.png',
    ...
    1601: () => hero(42).name('凝光').offline('v1').liyue().geo().catalyst()
        ...
        .normalSkill('千金掷')
        .skills(
            skill('璇玑屏').description('{dealDmg}，生成【sts116011】。')
            ...
            skill('天权崩玉').description('{dealDmg}，如果【sts116011】在场，就使此伤害+2。')
                ...
                .burst(3).damage(6).cost(3).handle(event => ({ addDmgCdt: isCdt(event.combatStatus.has(116011), 2) }))
        ),

    1602: () => hero(43).name('诺艾尔').offline('v1').maxHp(12).maxHp(10, 'v5.5.0', 'v1').mondstadt().geo().claymore()
        ...
        .normalSkill('西风剑术·女仆')
        .skills(
            skill('护心铠').description('{dealDmg}，生成【sts116021】。')
            ...
            skill('大扫除').description('{dealDmg}，本角色附属【sts116022】。')
    ...
    1603: () => hero(44).name('钟离').since('v3.7.0').offline('v2').maxHp(12).maxHp(10, 'v5.5.0', 'v2').liyue().geo().polearm()
        ...
        .normalSkill('岩雨')
        .skills(
            skill('地心').description('{dealDmg}，召唤【smn116031】。')
            ...
            skill('地心·磐礴').description('{dealDmg}，召唤【smn116031】，生成【sts116032】。')
            ...
            skill('天星').description('{dealDmg}，目标角色附属【sts116033】。')
    ...
    1604: () => hero(45).name('阿贝多').since('v4.0.0').offline('v2').maxHp(12).maxHp(10, 'v5.7.0', 'v2').mondstadt().geo().sword()
        ...
        .normalSkill('西风剑术·白')
        .skills(
            skill('创生法·拟造阳华').description('召唤【smn116041】。')
            ...
            skill('诞生式·大地之潮').description('{dealDmg}。如果【smn116041】在场，就使此伤害+2。')
    ...
    1605: () => hero(46).name('荒泷一斗').since('v3.6.0').offline('v3').inazuma().geo().claymore()
        ...
        .normalSkill('喧哗屋传说')
        .skills(
            skill('魔杀绝技·赤牛发破！').description('{dealDmg}，召唤【smn116051】，本角色附属【sts116054】。')
            ...
            skill('最恶鬼王·一斗轰临！！').description('{dealDmg}，本角色附属【sts116053】。')
    ...
    1606: () => hero(283).name('五郎').since('v4.3.0').offline('v3').inazuma().geo().bow()
        ...
        .normalSkill('呲牙裂扇箭')
        .skills(
            skill('犬坂吠吠方圆阵').description('{dealDmg}，生成【sts116061】。')
            ...
            skill('兽牙逐突形胜战法').description('{dealDmg}，生成【sts116061】，召唤【smn116062】。')
    ...
    1607: () => hero(366).name('云堇').since('v4.7.0').liyue().geo().polearm()
        ...
        .normalSkill('拂云出手')
        .skills(
            skill('旋云开相').description('生成【sts116073】，本角色附属【sts116071】并[准备技能]：【rsk16074】。')
    ...
    1608: () => hero(396).name('娜维娅').since('v4.8.0').fontaine(HERO_TAG.ArkheOusia).geo().claymore()
        ...
        .normalSkill('直率的辞绝')
        .skills(
            skill('典仪式晶火').description('{dealDmg}，本角色附属【sts116084】\\；从手牌中[舍弃]至多5张【crd116081】，每[舍弃]1张都使此伤害+1并抓1张牌。')
                ...
                .elemental().damage(3).cost(3).handle(event => {
                    ...
                    cmds.discard({ cnt, card: 116081 }).getCard(cnt)
                    return { addDmgCdt: cnt, status: 116084 }
                }),
            skill('如霰澄天的鸣礼').description('{dealDmg}，对所有敌方后台角色造成1点[穿透伤害]。召唤【smn116082】，生成1张【crd116081】加入手牌。')
                ...
                .burst(2).damage(1).cost(3).handle(({ cmds }) => (cmds.getCard(1, { card: 116081 }), { pdmg: 1, summon: 116082 })),
            skill('互助关系网').description('【敌方角色受到结晶反应伤害后：】生成3张【crd116081】，随机置入我方牌库中。')
                ...
                .passive().handle(({ cmds }) => (cmds.addCard(3, 116081), { triggers: 'Crystallize-oppo' }))
        ),

    1609: () => hero(420).name('千织').since('v5.1.0').inazuma().geo().sword()
        ...
        .normalSkill('心织刀流')
        .skills(
            skill('羽袖一触').description('从3个【nbotsmn116097】中[挑选]1个召唤。')
    ...
    1610: () => hero(461).name('卡齐娜').since('v5.5.0').natlan().geo().polearm()
        ...
        .normalSkill('嵴之啮咬')
        .skills(
            skill('出击，冲天转转！').description('本角色附属【crd116102】，并进入【sts116104】，并获得2点「夜魂值」。（角色进入【sts116104】后不可使用此技能）')
            ...
            skill('现在，认真时间！').description('{dealDmg}，生成【sts116101】。')
    ...
    1611: () => hero(470).name('希诺宁').since('v5.6.0').maxHp(12).maxHp(10, 'v6.0.0').natlan().geo().sword()
        ...
        .normalSkill(skill => skill('锐锋攫猎').description('若自身附属【sts116111】，则回复1点「夜魂值」。')
            .handle(({ cmds }) => cmds.getNightSoul().res))
        .skills(
            skill('音火锻淬').description('本角色附属【crd116112】，进入【sts116111】并获得1点「夜魂值」。（角色进入【sts116111】后不可使用此技能）')
                .src('https://patchwiki.biligame.com/images/ys/2/21/kr1booceklshoie2ibpya9rri553pin.png',
            ...
            skill('豹烈律动！').description('{dealDmg}，抓1张牌，并且治疗我方受伤最多的角色1点。每层【sts116113】额外抓1张牌，每层其他属性的【源音采样】额外治疗1点。')
    ...
    1701: () => hero(47).name('柯莱').offline('v1').maxHp(11).maxHp(10, 'v6.3.0', 'v1').sumeru().dendro().bow()
        ...
        .normalSkill('祈颂射艺')
        .skills(
            skill('拂花偈叶').description('{dealDmg}。')
            ...
            skill('猫猫秘宝').description('{dealDmg}，召唤【smn117011】。')
    ...
    1702: () => hero(48).name('提纳里').since('v3.6.0').offline('v3').sumeru().dendro().bow()
        ...
        .normalSkill('藏蕴破障')
        .skills(
            skill('识果种雷').description('{dealDmg}，本角色附属【sts117021】。')
            ...
            skill('造生缠藤箭').description('{dealDmg}，对所有敌方后台角色造成1点[穿透伤害]。')
    ...
    1703: () => hero(49).name('纳西妲').since('v3.7.0').sumeru().dendro().catalyst()
        ...
        .normalSkill('行相')
        .skills(
            skill('所闻遍计').description('{dealDmg}，目标角色附属【sts117031】\\；如果在附属前目标角色已附属有【sts117031】，就改为对所有敌方角色附属【sts117031】。')
            ...
            skill('所闻遍计·真如').description('{dealDmg}，所有敌方角色附属【sts117031】。')
            ...
            skill('心景幻成').description('{dealDmg}，生成【sts117032】。')
    ...
    1704: () => hero(50).name('瑶瑶').since('v4.1.0').offline('v2').liyue().dendro().polearm()
        ...
        .normalSkill('颠扑连环枪')
        .skills(
            skill('云台团团降芦菔').description('召唤【smn117041】。')
            ...
            skill('云颗珊珊月中落').description('{dealDmg}，生成【sts117043】。')
    ...
    1705: () => hero(51).name('白术').since('v4.2.0').offline('v2').maxHp(11).maxHp(10, 'v5.7.0', 'v2').liyue().dendro().catalyst()
        ...
        .normalSkill('金匮针解')
        .skills(
            skill('太素诊要').description('{dealDmg}，召唤【smn117051】。')
            ...
            skill('愈气全形论').description('生成【sts117052】和【sts117053】。')
    ...
    1706: () => hero(284).name('艾尔海森').since('v4.3.0').sumeru().dendro().sword()
        ...
        .normalSkill('溯因反绎法')
        .skills(
            skill('共相·理式摹写').description('{dealDmg}，本角色附属【sts117061】。')
            ...
            skill('殊境·显象缚结').description('{dealDmg}。消耗【sts117061】，此伤害提升所消耗【sts117061】的持续回合值。如果消耗【sts117061】的持续回合为0/1/2，则为角色附属持续回合为3/2/1的【sts117061】。')
    ...
    1707: () => hero(336).name('绮良良').since('v4.5.0').offline('v3').inazuma().dendro().sword()
    ...
    1708: () => hero(367).name('卡维').since('v4.7.0').maxHp(12).maxHp(10, 'v6.0.0').sumeru().dendro().sword()
        ...
        .normalSkill('旋规设矩')
        .skills(
            skill('画则巧施').description('{dealDmg}，生成【sts117082】。')
            ...
            skill('繁绘隅穹').description('{dealDmg}，本角色附属【sts117081】，生成2层【sts117082】。')
    ...
    1709: () => hero(455).name('基尼奇').since('v5.4.0').natlan().dendro().claymore()
        ...
        .normalSkill('夜阳斗技')
        .skills(
            skill('悬猎·游骋高狩').description('选一个我方角色，自身附属【sts117091】并进入【sts117092】。{dealDmg}，然后与所选角色交换位置。')
            ...
            skill('向伟大圣龙致意').description('{dealDmg}，召唤【smn117093】。')
    ...
    1710: () => hero(462).name('艾梅莉埃').since('v5.5.0').fontaine(HERO_TAG.ArkhePneuma).dendro().polearm()
        ...
        .normalSkill('逐影枪术·改')
        .skills(
            skill('撷萃调香').description('召唤【smn117101】。')
            ...
            skill('香氛演绎').description('{dealDmg}。召唤【smn117103】。')
            ...
            skill('余薰').description('【我方〖smn115〗入场时：】下次双方角色使用技能后，触发一次【smn115】的回合结束效果。（每回合2次）')
                .src('https://patchwiki.biligame.com/images/ys/4/41/kobtwvnjjwrr6nnrlppc8ht5h0y8jpw.png',
    ...
    2101: () => hero(52).name('愚人众·冰萤术士').since('v3.7.0').offline('v3').fatui().cryo()
        ...
        .normalSkill(skill => skill('冰萤棱锥').catalyst().handle(event => {
            if (event.summons.has(121011)) return { summon: [[121011, 1]] }
        }))
        .skills(
            skill('虚雾摇唤').description('{dealDmg}，召唤【smn121011】。')
            ...
            skill('冰枝白花').description('{dealDmg}，本角色[附着冰元素]，生成【sts121012】。')
                ...
                .burst(3).damage(5).cost(3).handle(event => ({ isAttach: true, status: [[121012, event.summons.getUseCnt(121011)]] }))
        ),

    2102: () => hero(277).name('「女士」').since('v4.3.0').fatui().cryo()
        ...
        .normalSkill(skill => skill('霜锋霰舞').catalyst())
        .skills(
            skill('凛冽之刺').description('{dealDmg}，目标角色附属【sts121022】。')
            ...
            skill('红莲冰茧').description('{dealDmg}，治疗本角色2点。移除【sts121021】，本角色永久转换为[「焚尽的炽炎魔女」]形态。')
                ...
                .burst(2).damage(4).cost(3).handle(() => ({ heal: 2 })),
            skill('邪眼之威').description('战斗开始时，初始附属【sts121021】。')
    ...
    2103: () => hero(321).name('无相之冰').since('v4.4.0').maxHp(8).monster().cryo()
        ...
        .normalSkill(skill => skill('冰锥迸射').catalyst())
        .skills(
            skill('圆舞冰环').description('{dealDmg}，本角色附属【sts121031】。')
            ...
            skill('冰棱轰坠').description('{dealDmg}，对所有敌方后台角色造成1点[穿透伤害]，召唤【smn121033】。')
            ...
            skill('冰晶核心').description('战斗开始时，初始附属【sts121034】。')
    ...
    2104: () => hero(397).name('愚人众·霜役人').since('v4.8.0').maxHp(11).maxHp(10, 'v5.8.0').fatui().cryo()
        ...
        .normalSkill('迅捷剑锋')
        .skills(
            skill('霜刃截击').description('{dealDmg}。')
                ...
                .elemental().damage(3).cost(3),
            skill('掠袭之刺').description('{dealDmg}，本角色附属【sts121042】。')
            ...
            skill('血契掠影').description('【本角色使用技能后：】对敌方出战角色附属[可用次数]为（本技能最终伤害值-2）的【sts122】。（最多5层）')
    ...
    2201: () => hero(53).name('纯水精灵·洛蒂娅').offline('v1').maxHp(11).maxHp(10, 'v6.0.0', 'v1').monster().hydro()
        ...
        .skills(
            ...
            skill('潮涌与激流').description('{dealDmg}\\；我方每有1个召唤物，再使此伤害+1。')
    ...
    2202: () => hero(54).name('愚人众·藏镜仕女').offline('v3').fatui().hydro()
        ...
        .normalSkill(skill => skill('水弹').catalyst())
        .skills(
            skill('潋波绽破').description('{dealDmg}，目标角色附属【sts122021】。')
            ...
            skill('粼镜折光').description('{dealDmg}。')
    ...
    2203: () => hero(350).name('深渊使徒·激流').since('v4.6.0').maxHp(6).monster().hydro()
        ...
        .normalSkill('波刃锋斩')
        .skills(
            skill('洄涡锋刃').description('{dealDmg}，然后[准备技能]：【rsk22035】。')
            ...
            skill('激流强震').description('{dealDmg}，在对方场上生成【sts122033】。')
            ...
            skill('水之新生').description('战斗开始时，初始附属【sts122031】。')
    ...
    2204: () => hero(368).name('吞星之鲸').since('v4.7.0').maxHp(6).maxHp(5, 'v6.4.0').monster().hydro().cosmicCalamity()
        ...
        .skills(
            ...
            skill('横噬鲸吞').description('{dealDmg}，对敌方所有后台角色造成1点[穿透伤害]。召唤【smn122043】。')
            ...
            skill('无尽食欲').description('战斗开始时，生成【sts122041】。')
    ...
    2205: () => hero(409).name('丘丘水行游侠').since('v5.0.0').maxHp(11).maxHp(10, 'v5.7.0').hilichurl().hydro()
        ...
        .normalSkill('镰刀旋斩')
        .skills(
            skill('狂澜镰击').description('{dealDmg}。；如果有敌方角色附属有【sts106】或【sts122052】，则本角色获得1点[充能]。（每回合1次）')
            ...
            skill('浮泡攻势').description('{dealDmg}，生成手牌【crd122051】。')
    ...
    2206: () => hero(523).name('水形幻人').since('v6.1.0').maxHp(11, 'v6.4.0').maxHp(12, 'v6.3.0').monster().hydro()
        ...
        .skills(
            skill('汛波').description('{dealDmg}，随机触发我方1个「召唤物」的「结束阶段」效果。如果自身生命值不低于2，则自身受到1点[穿透伤害]。')
                .src('https://patchwiki.biligame.com/images/ys/1/10/su0sccv2spovcnu82xt4chyy2dcmj4p.png',
                    'https://act-upload.mihoyo.com/wiki-user-upload/2025/10/21/258999284/def43673b9ab24e997dc05bfaed0c41f_6460874372753487667.png')
                .elemental().damage(2).cost(3).handle(({ hero: { hp } }) => ({ pdmgSelf: isCdt(hp >= 2, 1) })),
            skill('洪啸').description('{dealDmg}，触发我方所有「召唤物」的「结束阶段」效果。')
                .src('https://patchwiki.biligame.com/images/ys/7/71/tqxncstxl5dxpclzngtam26ugro55zr.png',
                    'https://act-upload.mihoyo.com/wiki-user-upload/2025/10/21/258999284/2f9df765e37a12df49709ea337f815a0_1921835653620442794.png')
                .burst(3).damage(4).cost(3),
            skill('分流').description('【自身生命值不低于3，我方〖smn122061〗以外的「召唤物」离场时：】自身受到2点[穿透伤害]，召唤1个独立的【smn122061】。（每回合1次）')
                .src('https://patchwiki.biligame.com/images/ys/6/67/3u45omq6usccdetx4567mxp1w90rzpg.png',
                    'https://act-upload.mihoyo.com/wiki-user-upload/2025/10/21/258999284/04527aa814e29d5f801efff742695576_8625775376586066698.png')
                .passive().perCnt(1).handle(event => {
    ...
    2207: () => hero(546).name('圣骸角鳄').since('v6.3.0').maxHp(11).consecratedBeast().hydro()
        .src('https://act-webstatic.mihoyo.com/hk4e/e20200928calculate/item_icon/67c7f6fc/49d8176cf43a866b88bed5709e6a80c5.png')
    ...
    2301: () => hero(55).name('愚人众·火之债务处理人').offline('v2').maxHp(11).maxHp(9, 'v6.4.0', 'v2').maxHp(10, 'v4.3.0').fatui().pyro()
        ...
        .normalSkill('突刺')
        .skills(
            skill('伺机而动').description('{dealDmg}，本角色附属【sts123011】。')
            ...
            skill('焚毁之锋').description('{dealDmg}。')
                ...
                .burst(2).damage(5).cost(3),
            skill('潜行大师').description('战斗开始时，初始附属【sts123011】。')
    ...
    2302: () => hero(56).name('深渊咏者·渊火').since('v3.7.0').offline('v1').maxHp(6).monster().pyro()
        ...
        .normalSkill(skill => skill('拯救之焰').catalyst())
        .skills(
            skill('炽烈箴言').description('{dealDmg}。')
                ...
                .elemental().damage(3).cost(3),
            skill('天陨预兆').description('{dealDmg}，召唤【smn123021】。')
            ...
            skill('火之新生').description('战斗开始时，初始附属【sts123022】。')
    ...
    2303: () => hero(285).name('镀金旅团·炽沙叙事人').since('v4.3.0').eremite().pyro()
        ...
        .skills(
            ...
            skill('厄灵之能').description('【此角色受到伤害后：】如果此角色生命值不多于7，则获得1点[充能]。（每回合1次）')
    ...
    2304: () => hero(351).name('铁甲熔火帝皇').since('v4.6.0').maxHp(5).maxHp(6, 'v5.4.0').monster().pyro()
        ...
        .normalSkill('重钳碎击')
        .skills(
            skill('烈焰燃绽').description('{dealDmg}\\；如果本角色附属有至少7层【sts123041】，则此伤害+1。；然后，本角色附属2层【sts123041】。')
                ...
                .elemental().damage(1).cost(3).handle(event => {
                    const { hero: { heroStatus } } = event;
                    const sts123041Cnt = heroStatus.getUseCnt(123041);
                    return { addDmgCdt: isCdt(sts123041Cnt >= 7, 1), status: [[123041, 2]] }
                }),
            skill('战阵爆轰').description('本角色[准备技能]：【rsk23046】。')
            ...
            skill('帝王甲胄').description('战斗开始时：初始附属5层【sts123041】。；【我方执行任意行动后：】如果我方场上存在【sts123041】以外的[护盾]状态或[护盾]出战状态，则将其全部移除\\；每移除1个，就使角色附属2层【sts123041】。')
                ...
                .passive().handle(event => {
                    ...
                    if (stsCnt == 0) return;
                    stsCnt += hero.heroStatus.getUseCnt(123041);
                    return {
    ...
    2305: () => hero(508).name('蚀灭的源焰之主').since('v6.0.0').maxHp(11).maxHp(12, 'v6.3.0').monster().pyro()
        ...
        .normalSkill('虚界玄爪')
        .skills(
            skill('蚀灭火羽').description('{dealDmg}，我方[舍弃]牌组顶部1张牌。')
            ...
            skill('斫劫源焰').description('{dealDmg}，对所有敌方后台角色造成1点[穿透伤害]。双方[舍弃]牌组顶部3张牌，自身附属1层【sts123051】.')
            ...
            skill('忿恨').description('我方每[舍弃]6张卡牌，自身附属1层【sts123051】。')
    ...
    2401: () => hero(57).name('无相之雷').since('v3.7.0').offline('v2').maxHp(8).monster().electro()
        ...
        .normalSkill(skill => skill('雷晶投射').catalyst())
        .skills(
            skill('猜拳三连击').description('{dealDmg}，然后分别[准备技能]：【rsk24015】和【rsk24016】。')
            ...
            skill('雳霆镇锁').description('{dealDmg}，召唤【smn124013】。')
            ...
            skill('雷晶核心').description('战斗开始时，初始附属【sts124014】。')
    ...
    2402: () => hero(286).name('雷音权现').since('v4.3.0').monster().electro()
        ...
        .normalSkill(skill => skill('轰霆翼斩').catalyst())
        .skills(
            skill('雷墙倾轧').description('对附属有【sts124022】的敌方角色{dealDmg}。（如果敌方不存在符合条件角色，则改为对出战角色造成伤害）')
                ...
                .elemental().damage(3).cost(3).handle(event => ({ atkTo: event.eheros.find(h => h.heroStatus.has(124022))?.hidx })),
            skill('轰雷禁锢').description('{dealDmg}，召唤【smn124023】。')
            ...
            skill('雷霆探知').description('战斗开始时，在敌方场上生成【sts124021】。')
    ...
    2403: () => hero(322).name('千年珍珠骏麟').since('v4.4.0').offline('v3').maxHp(8).monster().electro()
        ...
        .normalSkill('旋尾扇击')
        .skills(
            skill('霞舞鱼群').description('{dealDmg}。；【每回合1次：】如果本角色已附属【sts124032】，则使其[可用次数]+1。')
                ...
                .elemental().damage(3).cost(3).perCnt(1).handle(event => {
                    ...
                    const sts124032 = heroStatus.get(124032);
            ...
            skill('原海古雷').description('{dealDmg}，本角色附属【sts124032】，召唤【smn124031】。')
            ...
            skill('明珠甲胄').description('战斗开始时，本角色附属【sts124032】。')
    ...
    2404: () => hero(337).name('愚人众·雷萤术士').since('v4.5.0').fatui().electro()
        ...
        .skills(
            skill('雾虚之召').description('召唤【smn124041】。')
            ...
            skill('霆雷之护').description('{dealDmg}，本角色[附着雷元素]，生成【sts124042】并[准备技能]：【rsk24044】。')
                ...
                .burst(2).damage(1).cost(3).handle(event => ({ isAttach: true, status: [[124042, event.summons.getUseCnt(124041)], 124043] }))
        ),

    2405: () => hero(369).name('圣骸毒蝎').since('v4.7.0').consecratedBeast().electro()
        ...
        .normalSkill('蝎爪钳击')
        .skills(
            skill('蝎尾锥刺').description('{dealDmg}。；生成1张【crd124051】，随机置入我方牌库顶部2张牌之中。')
                ...
                .elemental().damage(3).cost(3).handle(({ cmds }) => cmds.addCard(1, 124051, { scope: 2 }).res),
            skill('雷锥散射').description('{dealDmg}，[舍弃]手牌中最多3张【crd124051】，在对方场上生成【sts124052】。')
                ...
                .burst(2).damage(3).cost(3).handle(event => {
                    ...
                    const cnt = Math.min(3, hcards.filter(c => c.id == 124051).length);
                    if (cnt == 0) return;
                    cmds.discard({ cnt, card: 124051 });
                    return { statusOppo: [[124052, cnt]] }
                }),
            skill('不朽亡骸·雷').description('回合结束时，生成两张【crd124051】，随机置入我方牌库顶部10张牌中。')
                ...
                .passive().handle(({ cmds }) => (cmds.addCard(2, 124051, { scope: 10 }), { triggers: 'turn-end' }))
        ),

    2406: () => hero(421).name('深渊咏者·紫电').since('v5.1.0').maxHp(6).monster().electro()
        ...
        .normalSkill(skill => skill('渊薮落雷').catalyst())
        .skills(
            skill('秘渊虚霆').description('{dealDmg}。；如果目标已[附着雷元素]，则夺取对方1点[充能]。（如果夺取时此角色[充能]已满，则改为由下一个[充能]未满的角色获得[充能]）')
                ...
                .elemental().damage(3).cost(3).handle(event => {
                    const { eDmgedHero, heros, cmds } = event;
                    if (!eDmgedHero.attachElement.includes(ELEMENT_TYPE.Electro) || eDmgedHero.energy == 0) return;
                    const hidxs = heros.allHidxs({ cdt: h => !h.isFullEnergy, limit: 1 });
                    cmds.getEnergy(-1, { isOppo: true }).getEnergy(1, { hidxs });
                }),
            skill('狂迸骇雷').description('{dealDmg}。如果目标[充能]不多于1，造成的伤害+2。')
                ...
                .burst(2).damage(3).cost(3).handle(event => {
                    if (event.eDmgedHero.energy > 1) return;
                    return { addDmgCdt: 2 }
                }),
            skill('雷之新生').description('战斗开始时，初始附属【sts124061】。')
    ...
    2501: () => hero(58).name('魔偶剑鬼').offline('v3').monster().anemo()
        ...
        .normalSkill('一文字')
        .skills(
            skill('孤风刀势').description('召唤【smn125011】。').description('{dealDmg},召唤【smn125011】。', 'v3.4.0')
                ...
                .elemental().damage(1, 'v3.4.0').cost(3).handle(({ talent, cmds }) => (talent && cmds.switchAfter(), { summon: 125011 })),
    ...
    2502: () => hero(287).name('特瓦林').since('v4.3.0').monster().anemo()
        ...
        .normalSkill('裂爪横击')
        .skills(
            skill('暴风轰击').description('{dealDmg}，目标角色附属【sts125021】。')
            ...
            skill('风龙涤流').description('{dealDmg}，然后分别[准备技能]：【rsk25025】和【rsk25026】。')
            ...
            skill('终天闭幕曲').description('{dealDmg}，所有敌方后台角色附属【sts125021】。')
    ...
    2503: () => hero(370).name('圣骸飞蛇').since('v4.7.0').consecratedBeast().anemo()
        ...
        .normalSkill('旋尾迅击')
        .skills(
            skill('盘绕风引').description('{dealDmg}，抓1张牌。')
                ...
                .elemental().damage(3).damage(2, 'v4.8.0').cost(3).perCnt(2).handle((event, ver) => {
                    const { hcards, pile, skill, cmds } = event;
                    if (ver.gte('v4.8.0')) return cmds.getCard(1).res;
                    cmds.getCard(1, { card: 124051, isFromPile: true });
                    let cnt = hcards.filter(c => c.id == 124051).length;
                    if (skill.perCnt > 0) {
                        if (hcards.length < 10 && pile.findIndex(c => c.id == 124051) > -1) ++cnt;
                        cnt = Math.min(skill.perCnt, cnt);
                        cmds.getCard(cnt);
                    }
                    return { exec: () => skill.minusPerCnt(cnt) }
                }),
            skill('错落风涡').description('{dealDmg}，[舍弃]手牌中所有的【crd124051】，每[舍弃]2张，此次伤害翻倍1次。')
                ...
                .burst(2).damage(2).cost(3).handle(event => {
                    ...
                    cmds.discard({ cnt, card: 124051 })
                    return { multiDmgCdt: 2 ** Math.floor(cnt / 2) }
                }),
            skill('不朽亡骸·风').description('战斗开始时，生成6张【crd124051】，均匀放入牌库。')
    ...
    2601: () => hero(59).name('丘丘岩盔王').offline('v2').maxHp(8, 'v6.4.0', 'v2').hilichurl().geo()
        ...
        .skills(
            skill('Movo Lawa').description('{dealDmg}。')
            ...
            skill('Upa Shato').description('{dealDmg}。')
            ...
            skill('魔化：岩盔').description('战斗开始时，初始附属【sts126011】和【sts126012】。')
    ...
    2602: () => hero(278).name('若陀龙王').since('v4.3.0').monster().geo()
        ...
        .avatar('https://act-webstatic.mihoyo.com/hk4e/e20200928calculate/item_char_icon_ud1cjg/949d01e6a23ceba1d6adeae6ac445374.png',
            '#MonsterIcon_DahakaIce',
            '#MonsterIcon_DahakaWater',
            '#MonsterIcon_DahakaFire',
            '#MonsterIcon_DahakaElec')
        .normalSkill('碎岩冲撞')
        .skills(
            skill('磅礴之气').description('{dealDmg}，如果发生了结晶反应，则角色[汲取对应元素的力量]。；如果本技能中角色未汲取元素的力量，则附属【sts126021】。')
            ...
            skill('山崩毁阵').description('{dealDmg}，每汲取过一种元素此伤害+1。')
                ...
                .burst(2).damage(4).cost(3).handle(event => ({ addDmgCdt: event.hero.heroStatus.getUseCnt(126021) })),
            skill('磐岩百相').description('战斗开始时，初始附属【sts126021】。')
    ...
    2603: () => hero(434).name('黄金王兽').since('v5.2.0').monster().geo()
        ...
        .normalSkill('王狼直击')
        .skills(
            skill('兽境轰召').description('{dealDmg}，并使对方出战角色附属2层【sts126031】，召唤【smn126032】。')
            ...
            skill('黄金侵绞').description('{dealDmg}，对所有敌方后台角色造成1点[穿透伤害]，并使所有敌方角色附属【sts126031】。')
    ...
    2604: () => hero(535).name('黑蛇骑士·摧岩之钺').since('v6.2.0').maxHp(12).monster().geo()
        ...
        .normalSkill('顶位迅斩')
        .skills(
            skill('斧盾震击').description('{dealDmg}。')
                .src('https://patchwiki.biligame.com/images/ys/6/6d/rmvzlb8ijzthe7kueujes4ywn77sa9q.png',
                ...
                .elemental().damage(3).cost(3),
            skill('坚岩姿态').description('自身[附着岩元素]，[准备技能]：【rsk26045】，然后[准备技能]：【rsk26047】。')
                .src('https://patchwiki.biligame.com/images/ys/0/05/3t8r6jlyi5c23j1bykv14re0uufy47z.png',
            ...
            skill('攻阵气势').description('如果敌方场上存在【伤害抵消】、[护盾]状态\\；或存在【伤害抵消】、[护盾]出战状态，则我方角色使用技能后，自身附属1层【sts126041】。')
                .src('https://patchwiki.biligame.com/images/ys/5/55/nh2m4dta3lud00vlua0wlprba01enbb.png',
    ...
    2701: () => hero(60).name('翠翎恐蕈').offline('v1').maxHp(12).maxHp(10, 'v6.4.0', 'v1').monster().dendro()
        ...
        .normalSkill('菌王舞步')
        .skills(
            skill('不稳定孢子云').description('{dealDmg}。')
                ...
                .elemental().damage(3).cost(3),
            skill('尾羽豪放').description('{dealDmg}，消耗所有「【sts127011】」层数，每层使本伤害+1。')
                ...
                .burst(2).damage(4).cost(3).handle(event => ({ addDmgCdt: event.hero.heroStatus.getUseCnt(127011) })),
            skill('活化激能').description('战斗开始时，初始附属【sts127011】。')
    ...
    2702: () => hero(371).name('阿佩普的绿洲守望者').since('v4.7.0').monster().dendro()
        ...
        .normalSkill('失乡重击')
        .skills(
            skill('生命流束').description('{dealDmg}，抓1张【crd127021】，生成1层【sts127026】。')
                ...
                .elemental().damage(2).cost(3).handle(({ cmds }) => (cmds.getCard(1, { card: 127021, isFromPile: true }), { statusPre: 127026 })),
            skill('终景迸落').description('{dealDmg}，抓1张【crd127021】，生成2层【sts127026】。')
                ...
                .burst(2).damage(2).cost(3).handle(({ cmds }) => (cmds.getCard(1, { card: 127021, isFromPile: true }), { statusPre: [[127026, 2]] })),
            skill('增殖感召').description('战斗开始时，生成5张【crd127021】，随机放入牌库。我方召唤4个【smn127022】后，此角色附属【sts127027】，并获得1点[护盾]。')
    ...
    2703: () => hero(422).name('镀金旅团·叶轮舞者').since('v5.1.0').eremite().dendro()
        ...
        .normalSkill('叶轮轻扫')
        .skills(
            skill('蔓延旋舞').description('{dealDmg}，生成1层【sts127033】。')
            ...
            skill('厄灵苏醒·草之灵蛇').description('{dealDmg}。整场牌局限制一次，将一张【crd127032】加入我方手牌。')
                ...
                .burst(2).damage(4).cost(3).handle(event => {
                    const { skill: { useCnt }, cmds } = event;
                    if (useCnt == 0) cmds.getCard(1, { card: 127032 });
                }),
            skill('厄灵之能').description('【此角色受到伤害后：】如果此角色生命值不多于7，则获得1点[充能]。（每回合1次）')
    ...
    2704: () => hero(494).name('贪食匿叶龙山王').since('v5.8.0').maxHp(8).monster().dendro()
        ...
        .normalSkill('沉重尾击')
        .skills(
            skill('喷吐草实').description('{dealDmg}，抓1张「料理」牌。')
                .src('https://patchwiki.biligame.com/images/ys/8/89/9enz71x2duiyweel6vsj3hscc3p4yhg.png',
            ...
            skill('榴果爆轰').description('{dealDmg}。')
                .src('https://patchwiki.biligame.com/images/ys/8/89/9enz71x2duiyweel6vsj3hscc3p4yhg.png',
            ...
            skill('贪食之王').description('自身不会【sts303300】。；【我方打出「料理」牌后：】随机附属1层【sts127041】或【sts127042】，或获得1点额外最大生命值。（每回合2次）')
    ...
    6301: () => hero().name('焚尽的炽炎魔女').since('v4.3.0').fatui().pyro()
        ...
        .normalSkill(skill => skill('红莲之蛾').catalyst())
        .skills(
            skill('烬灭之鞭').description('{dealDmg}，目标角色附属【sts163011】。')
            ...
            skill('燃焰旋织').description('{dealDmg}。')
